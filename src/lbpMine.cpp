...
/***********************************************
 *
 *      Filename: lbpTest.cpp
 *
 *        Author: yx - yixiu@inspur.com
 *   Description: ---
 *        Create: 2015-04-16 09:20:56
 * Last Modified: 2015-04-16 09:20:56
 ************************************************/
#include "lbpMine.h"
#include <iostream>
#include <fstream>
...
using namespace std;
#define TEST
void LBPMINE::elbpCircle(Mat& src, Mat &dst, int radius, int neighbors)
{
...
void LBPMINE::elbpRectangle(Mat& src, Mat &dst)
{
