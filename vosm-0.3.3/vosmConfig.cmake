...
# ======================================================
INCLUDE_DIRECTORIES("/home/yx/fr/project/imageParser/vosm-0.3.3" "/home/yx/fr/project/imageParser/vosm-0.3.3/include" "/home/yx/fr/project/imageParser/vosm-0.3.3/include/vosm")
# Provide the include directories to the caller
SET(VOSM_INCLUDE_DIRS "/home/yx/fr/project/imageParser/vosm-0.3.3" "/home/yx/fr/project/imageParser/vosm-0.3.3/include" "/home/yx/fr/project/imageParser/vosm-0.3.3/include/vosm")

# ======================================================
# Link directories to add to the user project:
# ======================================================
LINK_DIRECTORIES("/home/yx/fr/project/imageParser/vosm-0.3.3/lib")
# Provide the libs directory anyway, it may be needed in some cases.
SET(VOSM_LIB_DIR "/home/yx/fr/project/imageParser/vosm-0.3.3/lib")
...
foreach(__CVLIB ${VOSM_LIB_COMPONENTS})
	...
	if (CMAKE_MAJOR_VERSION GREATER 2  OR  CMAKE_MINOR_VERSION GREATER 4)
		# Modern CMake:
		SET(VOSM_LIBS ${VOSM_LIBS} debug ${__CVLIB} optimized ${__CVLIB})
	else(CMAKE_MAJOR_VERSION GREATER 2  OR  CMAKE_MINOR_VERSION GREATER 4)
		# Old CMake:
		SET(VOSM_LIBS ${VOSM_LIBS} ${__CVLIB})
...
IF (NOT 1)
	...
	LINK_DIRECTORIES("/home/yx/fr/project/imageParser/vosm-0.3.3/3rdparty/lib")
...
SET(VOSM_VERSION_MAJOR  0)
SET(VOSM_VERSION_MINOR  3)
SET(VOSM_VERSION_PATCH  2)
